...
export interface Page {
  ...
  hero: {
    ...
    /**
     * Displayed full width with a 16:9 aspect ratio. Height cannot be changed.
     */
    mainFocusLogo?: (number | null) | Media;
...
export interface FullWidthImageBlock {
  ...
  /**
   * Paste external 3rd party contact or email form embed code.
   */
...
export interface LegalPage {
  id: number;
  /**
   * e.g. "Privacy Policy", "Terms & Conditions"
   */
  title: string;
  content: {
    root: {
  ...
  /**
   * Auto-generated from "title". Check "Slug Lock" above to edit manually.
   */
  slug: string;
  /**
   * Check to stop the slug from regenerating when the title changes.
   */
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        introductionBlock?: T | IntroductionBlockSelect<T>;
        fullWidthImageBlock?: T | FullWidthImageBlockSelect<T>;
        breakdownBlock?: T | BreakdownBlockSelect<T>;
        textFeatureBlock?: T | TextFeatureBlockSelect<T>;
